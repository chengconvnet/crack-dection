...
def create_history(model, epochs, batch_size, train_generator, validation_generator, save_path_mode):
    # 模型保存格式默认是saved_model,可以自己定义更改原有类来保存hdf5
    ckpt = ModelCheckpoint(save_path_mode, monitor='val_accuracy', verbose=1,
